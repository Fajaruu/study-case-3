...
public class Main {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Map<String, NomorPesanan> nomorPesanan = new HashMap<>();
        boolean exit = false;
    ...
    public static void addToCart(LinkedHashMap<String, Customer> customer, Map<String, Menu> menu, Map<String, Map<String, Integer>> cart, String input) {
        ...
        if (customer.containsKey(idPel) && menu.containsKey(idMenu)) {
            ...
            if (isMenuExist) { // jika menu sebelumnya belum ada
            ...
            for (Map.Entry<String, Promo> promoEntry : promos.entrySet()) {
                if (cus instanceof CustomerMember) {
                    ...
                    if (today.isAfter(tanggalPromoAkhir) || (today.isBefore(tanggalPromoAwal))) {
                        ...
                        berlaku = true;
                        Applicable.PercentOffPromo diskonPersen = new Applicable.PercentOffPromo(kodePromo, berlaku, promo.getPersenPotongan());
                        ...
                        berlaku = true;
                        Applicable.CashBack cashBack = new Applicable.CashBack(kodePromo, berlaku, promo.getMaksPotongan());
    ...
    public static void systemPrint(Map<String, NomorPesanan> nomorPesananMap1, LinkedHashMap<String, Customer> customer, Map<String, Menu> menu, Map<String, Map<String, Integer>> cart, Map<String, Promo> promos, Map<String, CheckOut> co, String input) {
        String[] data = input.split(" ");
        String idPel = data[1];
                    ...
                    for (Map.Entry<String, Promo> promoEntry : promos.entrySet()) {
                        ...
                        if (appliedPromos.containsKey(idPel) && appliedPromos.get(idPel).equals(kodePromo)) {
                            ...
                            if (prm.getJenisPromo().equals("DISCOUNT")) {
                                ...
                                double sisaSaldo = cus.getSaldoAwal() - totalPlesOngkir;
                                ...
                                System.out.println("===============================================================");
                                System.out.printf("Total:%37.0f%n", totalPromo);
                                System.out.printf("Sisa saldo:%32.0f%n", cus.getSaldoAwal());
                                System.out.println("===============================================================");
                                System.out.println();
                                break;
                            }
                            ...
                            System.out.printf("Sisa saldo:%32.0f%n", cus.getSaldoAwal() - (total + cus.getOngkir()));
                            System.out.println("===============================================================");
                            break;
                        }
                    }
                    ...
                    for (Map.Entry<String, Promo> promoEntry : promos.entrySet()) {
                        ...
                        for (Map.Entry<String, Integer> entry : cartItem.entrySet()) {
                            ...
                            if (menu.containsKey(idMenu)) {
                                ...
                                if (appliedPromos.containsKey(idPel) && appliedPromos.get(idPel).equals(kodePromo)) {
                                    NomorPesanan nomor = new NomorPesanan(currentNomor, totalQty, total, kodePromo);

                                    nomorPesananMap1.put(idPel, nomor);
                                } else if (!appliedPromos.containsKey(idPel)) {
                                    NomorPesanan nomorPesanan = new NomorPesanan(currentNomor, totalQty, total, null);

                                    nomorPesananMap1.put(idPel, nomorPesanan);
                                }
                            }
                        }
                        if (appliedPromos.containsKey(idPel) && appliedPromos.get(idPel).equals(kodePromo)) {
                            ...
                            if (prm.getJenisPromo().equals("DISCOUNT")) {
                                double totalPromo = (total + cus.getOngkir());
                                double sisaSaldo = cus.getSaldoAwal() - totalPromo;

                                System.out.println("PROMO:" + kodePromo + "                         -" + prm.getHargaDiskon());
                                System.out.printf("Ongkos Kirim:%30.0f%n", cus.getOngkir());
                                System.out.println("===============================================================");
                                System.out.printf("Total:%37.0f%n", totalPromo);
                                System.out.printf("Sisa saldo:%37.0f%n", sisaSaldo);
                                System.out.println("===============================================================");
                                System.out.println();
                                break;
                            } else if (prm.getJenisPromo().equals("CASHBACK")) {
                                ...
                                System.out.println("PROMO:" + kodePromo + "                         " + prm.getHargaDiskon());
                                System.out.printf("Total:%37.0f%n", totalPlesOngkir);
                                System.out.printf("Sisa saldo:%37.0f%n", saldoCashback);
                                System.out.println("===============================================================");
                                break;
                            } else if (prm.getJenisPromo().equals("DELIVERY")) {
                                double totalPromo = (total + cus.getOngkir());
    ...
    public static void printHistory(Map<String, NomorPesanan> nomorPesananMap1, LinkedHashMap<String, Customer> customer, Map<String, Menu> menu, Map<String, Map<String, Integer>> cart, Map<String, Promo> promos, Map<String, CheckOut> co, String input) {
        // PRINT_HISTORY A001
        String[] data = input.split(" ");
        String idPelanggan = data[1];
        ...
        for (Map.Entry<String, NomorPesanan> printHistory : nomorPesananMap1.entrySet()) {
            NomorPesanan value = printHistory.getValue();

            int nomor = value.getNomorPesanan();
            int qty = value.getQty();
            int totalSemua = (int) value.getSubtotal();
            String kodePromo = value.getKodePromo();
